...
//        
//        let offScreenRight = CGAffineTransformMakeRotation(-CGFloat(M_PI)/2)
...
//        UIView.animateWithDuration(duration, delay: 0.0, usingSpringWithDamping: 0.65, initialSpringVelocity: 0.8, options: nil, animations: {
//            
